					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<table width="100%"
								...
								<tbody>
									<%
										for (HoatDong hd : hoatDongDAO.getCacHoatDong()) {
									%>
									<tr class="odd gradeX">
										<td><%=hd.getTenHoatDong()%></td>
										<%
											if (hd.getMoTa().length() > 110) {
										%>
										<td><%=hd.getMoTa().substring(0, 105) + "..."%></td>
										<%
											} else {
										%>
										<td><%=hd.getMoTa()%></td>
										...
										<a
											href="HoatDong?command=edit&mahd=<%=hd.getID()%>">Sửa</a></td>
										<td class="text-center"><a
											href="HoatDong?command=delete&mahd=<%=hd.getID()%>"
