				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<div class="row">
								<div class="col-lg-12">
									<form action="BoTieuChuan" method="post"
					...
					<div class="panel panel-default">
						<div class="panel-heading">Danh sách bộ tiêu chuẩn</div>
						<!-- /.panel-heading -->
						<%
							ArrayList<BoTieuChuan> listBTC = (ArrayList<BoTieuChuan>)request.getAttribute("btcs");
						%>

						<div class="panel-body">
							<form method="get" action="BoTieuChuan">
								<div class="form-group col-md-6">
									<input type="text" name="keyword" placeholder="Tên hoặc mã bộ tiêu chuẩn"
										class="form-control">
								</div>
								...
								<tbody>
									...
									<tr class="odd gradeX">
										...
										<td class="text-center"><a
											href="BoTieuChuan?command=edit&id=<%=btc.getID()%>">Sửa</a></td>
										<td class="text-center"><a
											href="BoTieuChuan?command=delete&id=<%=btc.getID()%>"
